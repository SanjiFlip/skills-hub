...
export const getSyncFailureKind = (error?: string | null) => {
  const kinds = ['network', 'tls', 'auth', 'credential', 'credentialMissing', 'visibility', 'publicUpload', 'privateKey', 'integrity', 'disk', 'permission', 'push', 'fetch', 'storage', 'targetModified', 'unknown']
